...
model new_r
  ...
  Modelica.Blocks.Interfaces.RealInput d annotation (
    Placement(visible = true, transformation(origin={-164,-80},    extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin={-164,-80},    extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant const(k=0.5)
    annotation (Placement(transformation(extent={{-130,-76},{-110,-56}})));
equation
  ...
  connect(const.y, pwm.dutyCycle) annotation (Line(points={{-109,-66},{-100,-66},
          {-100,-64},{-90,-64}}, color={0,0,127}));
  annotation (
