...
model cpl_boost3
  ...
  Modelica.Blocks.Interfaces.RealInput d annotation (
    Placement(visible = true, transformation(origin={-170,-62},    extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin={-134,-54},    extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
equation
  ...
  connect(voltageSensor.v,division. u2) annotation (Line(points={{7,8},{36,8},{
          36,-50},{78,-50}},       color={0,0,127}));
  ...
  connect(const.y, add3_1.u3) annotation (Line(points={{11,-102},{36,-102},{36,
          -46},{44,-46}}, color={0,0,127}));
  connect(add3_1.y, division.u1) annotation (Line(points={{67,-38},{72,-38},{72,
          -38},{78,-38}}, color={0,0,127}));
  connect(d, pwm.dutyCycle) annotation (Line(points={{-170,-62},{-134,-62},{
          -134,-58},{-98,-58}}, color={0,0,127}));
  annotation (
