# 算法,DDQN,11.08改成soft replacement
import torch
...
class Trainer:
    def __init__(self, state_dim, action_dim,  ram, e_greedy=0.1, batch_size=128, learning_rate=0.001, tau = 0.001, reward_decay = 0.99):
        # 初始化变量
    ...
    def optimize(self):
        utils.soft_update(self.target_net, self.eval_net, self.tau) # soft replacement
