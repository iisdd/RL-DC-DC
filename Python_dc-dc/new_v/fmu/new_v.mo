...
model new_v
  ...
  Modelica.Blocks.Sources.Constant const(k=0.29)
    annotation (Placement(transformation(extent={{-134,-42},{-114,-22}})));
...
equation
  ...
  connect(d, pwm.dutyCycle)
    annotation (Line(points={{-154,-68},{-96,-68}}, color={0,0,127}));
  annotation (
